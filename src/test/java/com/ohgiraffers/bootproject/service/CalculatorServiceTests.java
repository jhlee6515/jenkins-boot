...
class CalculatorServiceTests {
    ...
    private static Stream<Arguments> provideDTOSource() {
        return Stream.of(
                ...
                Arguments.of(new CalculatorDTO(7, 8)),
    ...
    void testPlus(CalculatorDTO calculatorDTO) {

        // when
        int expected = calculatorDTO.getNum1() + calculatorDTO.getNum2();

        // then
        int actual = calculatorService.plus(calculatorDTO);
